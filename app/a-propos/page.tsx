              ...
              <div className="means-grid" role="list">
                <article className="mean-item" role="listitem">
                  ...
                  <div className="mean-body">
                    ...
                    <p>
                      ...
                      dessinateur-projeteur, en lien direct avec la production
                      et la pose.
                    </p>
                  </div>
                </article>
                ...
                <article className="mean-item" role="listitem">
                  ...
                  <div className="mean-body">
                    ...
                    <p>
                      Une réactivitée à toute épreuve, nous répondons à toutes
                      vos urgences et vos besoins dans les meilleurs délais.
                    </p>
                  </div>
                </article>
              </div>
